 ...
 * @author joset
 */
public class DlgBuscarProductos extends JDialog {

    private final IBuscarProducto cuBuscarProducto;
    private List<ProductoDTO> resultadosActuales;
    private ProductoDTO seleccionado;

    public DlgBuscarProductos(Frame parent, boolean modal) {
        super(parent, modal);
        this.cuBuscarProducto = new BuscarProducto();
        initComponents();
        utileriaTablas.configurarTablaProductos(tblResultados);
        setLocationRelativeTo(parent);
        setTitle("MotoAmigo - Buscar Producto");
        estilarComponentes();
        try {
            buscar();
    ...
    private void initComponents() {
        ...
        setTitle("MotoAmigo - Buscar Producto");
        setMaximumSize(new java.awt.Dimension(661, 550));
        ...
        lblDescripcion.setText("Selecciona un producto de la lista.");
    ...
    private void seleccionarProducto() {
        ...
        if (filaModelo < 0 || filaModelo >= resultadosActuales.size()) {
            JOptionPane.showMessageDialog(
                    this,
        ...
        seleccionado = resultadosActuales.get(filaModelo);
