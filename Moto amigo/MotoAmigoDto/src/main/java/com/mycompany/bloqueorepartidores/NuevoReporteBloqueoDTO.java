 ...
 */
public class NuevoReporteBloqueoDTO {
    ...
    public NuevoReporteBloqueoDTO() {
    }

    public NuevoReporteBloqueoDTO(RepartidorDTO repartidor, MotivoDTO motivo, String detalles,
            byte[] imagenEvidencia, LocalDateTime fechaHora) {
